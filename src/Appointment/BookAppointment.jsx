...
//   { id: 6, name: 'Dr. Jony', specialization: 'Psychiartist', experience: '9 years' },
// ];
...
//       return;
//     }
//     alert(`Appointment booked with ${selectedDoctor.name} (${selectedDoctor.specialization}) on ${appointment.date}`);
//     handleClose();
//   };
...
//       {/* Modal */}
//       <Modal show={show && selectedDoctor !== null} onHide={handleClose} centered>
...
// src/Appointment/BookAppointment.js    payment not working for view
// import React, { useState } from 'react';
// import { Card, Button, Row, Col, Modal, Form } from 'react-bootstrap';
...
//     navigate('/payment', {
//       state: { doctor: selectedDoctor, appointment },
//     });
...
//       <Modal show={show && selectedDoctor} onHide={handleClose} centered>
//         <Modal.Header closeButton>
//           <Modal.Title>Book Appointment</Modal.Title>
//         </Modal.Header>
//         <Modal.Body>
...
//           <Button variant="primary" onClick={handleBook}>Proceed to Payment</Button>
//         </Modal.Footer>
//       </Modal>
//     </div>
